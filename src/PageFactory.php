...
class PageFactory {
    ...
    public function home() {
        if (!isset($this->_cached[__FUNCTION__])) {
            $title = 'ChipPanFire';
            $href = 'index.html';
            $this->_cached[__FUNCTION__] = new InternalPage($title, $href, new SimpleContent('content-homepage.phtml'));
        }

        return $this->_cached[__FUNCTION__];
    }
    ...
    public function music() {
        if (!isset($this->_cached[__FUNCTION__])) {
            $title = 'Music';
            $href = 'music.html';
            $this->_cached[__FUNCTION__] =  new InternalPage($title, $href, new SimpleContent('content-music.phtml'));
        }
    ...
    public function contact() {
        if (!isset($this->_cached[__FUNCTION__])) {
            $title = 'Contact';
            $href = 'contact.html';
            $this->_cached[__FUNCTION__] =  new InternalPage($title, $href, new SimpleContent('content-contact.phtml'));
        }
    ...
    public function software() {
        if (!isset($this->_cached[__FUNCTION__])) {
            ...
            $href = 'software.html';
            $this->_cached[__FUNCTION__] = new InternalPage($title, $href, new SoftwareHomeContent($this->linkedSoftwarePages()));
        }
    ...
    public function m4lDSM() {
        if (!isset($this->_cached[__FUNCTION__])) {
            ...
            $this->_cached[__FUNCTION__] = new InternalPage($title, $href, $content, $strapline);
        }
    ...
    public function kmkControlScript() {
        if (!isset($this->_cached[__FUNCTION__])) {
            ...
            $this->_cached[__FUNCTION__] =  new ExternalPage($title, $href, $strapline);
        }

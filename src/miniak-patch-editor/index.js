...
const MiniakPatchEditor = () => (
  <PageTemplate>
    ...
    <p>Miniak Patch Editor is a <ExternalLink href="https://www.cycling74.com/">MaxMSP</ExternalLink> patch that can be downloaded and used <strong>for free!</strong></p>
    ...
    <ul>
      ...
      <li>A template for controlling Miniak Patch Editor from the popular iDevice software
        <ExternalLink href="https://hexler.net/software/touchosc">TouchOSC</ExternalLink>, created by <strong>Adam
        Neddo</strong> (see documentation for contact details). <em>Note the template controls the editor
